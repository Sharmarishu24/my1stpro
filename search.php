...
<div class="container-fluid red-background size">
	...
	<option value="">-- Select --</option><optgroup title="Madhya Pradesh" label="&raquo; Madhya Pradesh"></optgroup><option value="Indore" ><option value="Indore" >Indore</option><option value="Ujjain" >Ujjain</option><option value="Bhopal" >Bhopal</option></select>
							</div>
