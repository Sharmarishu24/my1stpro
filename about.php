...
<div class="container-fluid white size">
	...
	<div class="container">
		...
		<div class="col-md-6">
			...
			<hr class="red-bar">
			<p>
				The goal of this website is to create the foundation for a web-based spatial inventorybof available donors of Blood and to provide information and importance about donating the blood.This project makes easier for every person using software in their required category.
			</p>
			<p>
	...
	<div class="container-fluid size">
		...
		<div class="col-md-6">
			...
			<hr class="red-bar">
			<p>
				Provide safe and quality blood and affordable cost to the general public and free of cost to the needy.
