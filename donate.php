<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    <span aria-hidden="true">&times;</span>
  			...
  			if(isset($_POST['city']) && !empty($_POST['cityError'])){
    ...
    <span aria-hidden="true">&times;</span>
  		...
  		if(isset($_POST['contact_no']) && !empty($_POST['contact_no'])){
  			...
  			if (preg_match('/\d[1]/',$_POST['contact_no'])) {
...
<div class="container size">
		...
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
            ...
            <?php if(isset($yearError))echo $yearError; ?>
              ...
              <input type="text" name="contact_no" value="" placeholder="03********" class="form-control" required pattern="^\d{11}$" title="10 numeric characters only" maxlength="10">
	...
	<option value="">-- Select --</option><optgroup title="Madhya Pradesh" label="&raquo; Madhya Pradesh"></optgroup><option value="Indore" >Indore</option><option value="Ujjain">Ujjain</option><option value="Nagda" >Nagda</option><option value="Bhopal" >Bhopal</option></select>
